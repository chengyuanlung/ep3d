...
**MET** — OCCT 8.0.1 + Qt 6.11.1, 322/322 tests in Debug and Release,
functional independent review APPROVE 96/100, UI accepted by owner manual
validation (seven of eight groups; 150% display scaling NOT EXECUTED).
